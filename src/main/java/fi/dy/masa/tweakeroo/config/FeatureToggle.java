...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_ENTITY_TYPE_PERIODIC_ATTACK_RESTRICTION("tweakEntityTypePeriodicAttackRestriction",true, "",    "Restricts which entities you are able to attack with 'tweakPeriodicAttack'.\nSee the corresponding 'entityPeriodicAttackRestriction*' configs in the Lists category."),
